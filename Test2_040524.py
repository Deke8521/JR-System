...
def load_job_dataset():
    try:
        ...
        job_dataset['Skills'] = job_dataset['Skills'].apply(clean_text)
        return job_dataset 
    except Exception as e:
...
def main():
    ...
    resume_input_method = st.selectbox("Select method to input resume: (PDF/Word doc)", ("Upload PDF", "Upload Word Document"))
